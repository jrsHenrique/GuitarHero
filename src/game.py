...
class GameMain():
    ...
    def __init__(self, chart, width=1280, height=800):
        ...
        self.fret0 = Fret(490, 720, Color('green'), 0, self)
        self.fret1 = Fret(565, 720, Color('red'), 1, self)
        self.fret2 = Fret(640, 720, Color('yellow'), 2, self)
        self.fret3 = Fret(715, 720, Color('blue'), 3, self)
        self.fret4 = Fret(790, 720, Color('orange'), 4, self)
